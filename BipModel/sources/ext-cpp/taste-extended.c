...
flag asn1SccT_Time_IsConstraintValid(const asn1SccT_Time* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = asn1SccT_UInt32_IsConstraintValid(&pVal->secs, pErrCode);
	if (ret) {
	    ret = asn1SccT_UInt32_IsConstraintValid(&pVal->nsecs, pErrCode);
...
flag asn1SccT_String_Encode(const asn1SccT_String* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	if (ret) {
	    BitStream_EncodeConstraintWholeNumber(pBitStrm, pVal->nCount, 0, 60);
...
flag asn1SccT_String_Decode(asn1SccT_String* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	ret = BitStream_DecodeConstraintWholeNumber(pBitStrm, &nCount, 0, 60);
...
const asn1SccT_UInt32 numT_String = 60;
